...
class DefaultConfig:
    ...
    PORT = 3978
    APP_ID = os.environ.get("MicrosoftAppId", "7c8932d2-13a9-401a-9a7d-1c81b1d18ab2")
    APP_PASSWORD = os.environ.get("MicrosoftAppPassword", "8AW8Q~UTomkmo.zoXHzWgrSoiuKJjsCiUobWAcHc")
